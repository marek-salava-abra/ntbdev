                      ...
                      mr.free;
                                              ...
                                              for mICount:=0 to mIBookmark do begin
                                                  ...
                                                  if (not mKumulovane) or ((mKumulovane) and (mICount=0)) then begin
                                                           mquery:=NxGetAPIHeadJSON(msite.BaseObjectSpace,self,'PieceList',mUser);
                                                  end;

                                                  mquery:=mquery + NxGetAPIPieceList(msite,self);
                                                  if mICount<>mIBookmark then begin
                                                   ...
                                                   if not mKumulovane then begin      // index=1 then begin
                                                    ...
                                                    if mOnline then begin
                                                         ...
                                                         mboolean:=InputQuery('API','Post 1 doklad',mtarget+'/script/NxApiLib/lib/APINxPLMPieceList' + Chr(10) + chr(10) +mQuery);

                                                           mString:=APICallString(msite.BaseObjectSpace,'POST',mtarget+'/script/NxApiLib/lib/APINxPLMPieceList',mQuery, true);
                                                                   // mReturnNewDocNumber:='';
                                                                   // mReturnSourceDoc:='';
    ...
    if copy(muser.GetFieldValueAsString('X_Button_parametr'),9,1)='1' then begin    // hromadná změna stavu
            ...
            {    mMAction := Self.GetNewMultiAction;
               ...
               { mMAction := Self.GetNewMultiAction;
                ...
                mMAction.Category := 'tabList';
                mMAction.Items.Add('Export Offline ');
                ...
                mMAction.Hint := 'Odeslání položky 1:1 ';
                mMAction.Category := 'tabList';
                mMAction.Items.Add('Export Online ');
                                ...
                                for i:=0 to mFileList.count-1 do begin
                                     ...
                                     if not FileExists(mdir + mFileList.Strings[i]+'.json') then begin
                                          ...
                                          try
                                              ...
                                              mString:=APICallString(msite.BaseObjectSpace,'POST',mSourceAPI + '/script/NxApiLib/lib/APINxPLMPieceList',mQuery, true);
