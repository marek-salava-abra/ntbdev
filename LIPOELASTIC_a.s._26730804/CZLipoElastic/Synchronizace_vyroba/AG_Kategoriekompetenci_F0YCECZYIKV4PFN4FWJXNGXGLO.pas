...
const
mTable='CRPCompetenceCategories';
mApiTable='CRPCompetenceCategories';
...
begin
    mQuery:='{'   ;
                  ...
                  mquery:=mquery + ', "Inalienability":"' +  NxFloatToIBStr(Self.GetFieldValueAsFloat('Inalienability')) +'" ';
                mquery:=mquery +'}';
...
//                                    end;
                        ...
                        IF mid='' THEN BEGIN
                            //NxShowSimpleMessage('Nový záznam se stejným ID',nil);
                              ...
                              if (xSite.CompanyCache.GetUserID='SUPER00000') and (mICount=0) and (index=1) then
                                                                mboolean:=InputQuery('API','PUT ',mtarget+'/'+mApiTable+'/' + mid + Chr(10) + chr(10) +mQuery);
