...
begin
    mQuery:='{'   ;
                  ...
                  mquery:=mquery + ', "MaterialExpense": '  +  NxFloatToIBStr(Self.GetFieldValueAsFloat('MaterialExpense')) +' ' ;
                mquery:=mquery +'}';
...
begin
    mNewQueryID:='{"info_type": "New_value" '
                                     +','+' "mSQL": "INSERT INTO ' + mtable + ' (Code,Name,ID,MaterialExpense) VALUES (' +
                                            quotedstr(Self.GetFieldValueAsString('Code'))
                                            + ','+ quotedstr(Self.GetFieldValueAsString('Name'))
                                            + ','+ quotedstr(Self.OID)
                                            + ','+ NxFloatToIBStr(Self.GetFieldValueAsFloat('MaterialExpense'))
                                            + ')"}';
         result:=mNewQueryID;
end;
