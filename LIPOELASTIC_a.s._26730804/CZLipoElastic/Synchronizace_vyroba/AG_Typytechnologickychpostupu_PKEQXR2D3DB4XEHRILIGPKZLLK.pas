...
const
mTable='PLMRoutineTypes';
mApiTable='PLMRoutineTypes';
...
begin
    mQuery:='{'   ;
                  ...
                  mquery:=mquery + ', "DefaultType": '  +  BoolToStr(Self.GetFieldValueAsBoolean('DefaultType')) +' ' ;
                  mquery:=mquery + ', "ManuallyEnteredRtn": '  +  BoolToStr(Self.GetFieldValueAsBoolean('ManuallyEnteredRtn')) +' ' ;
                mquery:=mquery +'}';
