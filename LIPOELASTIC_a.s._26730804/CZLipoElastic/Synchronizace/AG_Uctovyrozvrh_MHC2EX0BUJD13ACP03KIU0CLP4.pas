...
begin
     mQuery:='{}';
                  ...
                  mquery:=mquery + ', "AccountType":"' +  Self.GetFieldValueAsString('AccountType') +'" ';
                  mquery:=mquery + ', "AccountTypeName":"' +  Self.GetFieldValueAsString('AccountTypeName') +'" ';
                  mquery:=mquery + ', "Parent_ID":"' +  Self.GetFieldValueAsString('Parent_ID') +'" ';
                  mquery:=mquery + ', "Parent2_ID":"' +  Self.GetFieldValueAsString('Parent2_ID') +'" ';
                  mquery:=mquery + ', "VATIndex_ID":"' +  Self.GetFieldValueAsString('VATIndex_ID') +'" ';





                  mquery:=mquery + ', "BalanceAccount": '  +  BoolToStr(Self.GetFieldValueAsBoolean('BalanceAccount')) +' ' ;
//                  mquery:=mquery + ', "Closed": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Closed')) +' ' ;
                  mquery:=mquery + ', "IsCostForProjectControl": '  +  BoolToStr(Self.GetFieldValueAsBoolean('IsCostForProjectControl')) +' ' ;
                  mquery:=mquery + ', "IsIncomplete": '  +  BoolToStr(Self.GetFieldValueAsBoolean('IsIncomplete')) +' ' ;
                  mquery:=mquery + ', "IsRevenueForProjectControl": '  +  BoolToStr(Self.GetFieldValueAsBoolean('IsRevenueForProjectControl')) +' ' ;
                  mquery:=mquery + ', "PrintToAcumulatedStatement": '  +  BoolToStr(Self.GetFieldValueAsBoolean('PrintToAcumulatedStatement')) +' ' ;
                  mquery:=mquery + ', "Short": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Short')) +' ' ;
                  mquery:=mquery + ', "Taxable": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Taxable')) +' ' ;
                  mquery:=mquery + ', "Transferable": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Transferable')) +' ' ;
...
begin
    mNewQueryID:='{'   ;
                  mNewQueryID:=mNewQueryID + '"id": "' +  Self.OID +'"'  ;
                  mNewQueryID:=mNewQueryID + ', "Code":"' +  Self.GetFieldValueAsString('Code') +'" ';
                  mNewQueryID:=mNewQueryID + ', "Name":"' +  Self.GetFieldValueAsString('Name') +'" ';
                  mNewQueryID:=mNewQueryID + ', "Hidden": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Hidden')) +' ' ;

                  mNewQueryID:=mNewQueryID + ', "AccountType":"' +  Self.GetFieldValueAsString('AccountType') +'" ';
                  mNewQueryID:=mNewQueryID + ', "AccountTypeName":"' +  Self.GetFieldValueAsString('AccountTypeName') +'" ';
//                  mNewQueryID:=mNewQueryID + ', "Parent_ID":"' +  Self.GetFieldValueAsString('Parent_ID') +'" ';
//                  mNewQueryID:=mNewQueryID + ', "Parent2_ID":"' +  Self.GetFieldValueAsString('Parent2_ID') +'" ';
 //                 mNewQueryID:=mNewQueryID + ', "VATIndex_ID":"' +  Self.GetFieldValueAsString('VATIndex_ID') +'" ';





//                  mNewQueryID:=mNewQueryID + ', "BalanceAccount": '  +  BoolToStr(Self.GetFieldValueAsBoolean('BalanceAccount')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "Closed": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Closed')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "IsCostForProjectControl": '  +  BoolToStr(Self.GetFieldValueAsBoolean('IsCostForProjectControl')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "IsIncomplete": '  +  BoolToStr(Self.GetFieldValueAsBoolean('IsIncomplete')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "IsRevenueForProjectControl": '  +  BoolToStr(Self.GetFieldValueAsBoolean('IsRevenueForProjectControl')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "PrintToAcumulatedStatement": '  +  BoolToStr(Self.GetFieldValueAsBoolean('PrintToAcumulatedStatement')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "Short": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Short')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "Taxable": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Taxable')) +' ' ;
//                  mNewQueryID:=mNewQueryID + ', "Transferable": '  +  BoolToStr(Self.GetFieldValueAsBoolean('Transferable')) +' ' ;
