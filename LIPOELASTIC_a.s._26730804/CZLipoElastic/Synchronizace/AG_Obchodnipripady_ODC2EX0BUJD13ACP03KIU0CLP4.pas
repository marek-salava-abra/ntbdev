...
const
mTable='BusTransactions';
mApiTable='BusTransactions';
...
//                  mquery:=mquery + ', "Firm_ID":"' +  Self.GetFieldValueAsString('Firm_ID') +'" ';
                  ...
                  mquery:=mquery + ', "U_Analytika":"'  +  Self.GetFieldValueAsString('U_Analytika') +'" ' ;
                  mquery:=mquery + ', "U_Analytika_nakladu":"'  +  Self.GetFieldValueAsString('U_Analytika_nakladu') +'" ' ;
                  mquery:=mquery + ', "X_Stav":"'  +  Self.GetFieldValueAsString('X_Stav') +'" ' ;
                  mquery:=mquery + ', "X_Naklad":"'  +  Self.GetFieldValueAsString('X_Naklad') +'" ' ;
                  mquery:=mquery + ', "X_Vynos":"'  +  Self.GetFieldValueAsString('X_Vynos') +'" ' ;
                  mquery:=mquery + ', "X_Analytika":"'  +  Self.GetFieldValueAsString('X_Analytika') +'" ' ;
                  mquery:=mquery + ', "X_Typ_certifikace":"'  +  Self.GetFieldValueAsString('X_Typ_certifikace') +'" ' ;
                  mquery:=mquery + ', "X_Hlavni": '  +  BoolToStr(Self.GetFieldValueAsBoolean('X_Hlavni')) +' ' ;
