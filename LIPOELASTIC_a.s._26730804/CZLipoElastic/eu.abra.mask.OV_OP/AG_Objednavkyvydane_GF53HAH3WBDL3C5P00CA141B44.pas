...
begin
    if false then begin
          ...
          mMAction.Hint := 'Přeobjednání Třebíč';
          mMAction.Caption := 'Přeobjednání Třebíč';
...
begin
  ...
  try
    mDocHead.New;
    mDocHead.Prefill;
    if index=0 then mDocHead.SetFieldValueAsString('DocQueue_ID', '1U10000101');
    mDocHead.SetFieldValueAsString('Firm_ID', '2D15000101');
   ...
   // mDocHead.SetFieldValueAsString('ConstSymbol_ID', ABO.GetFieldValueAsString('ConstSymbol_ID'));
    ...
    try
      ...
      for i := 0 to mList.Count-1 do begin
        ...
        if index=0 then mNewRow.SetFieldValueAsString('Store_ID', '2Z00000101');
