  ...
  if mForm.ShowModal(mSite) = mrOK then begin
                      ...
                      if mRbS.Checked then begin
                        ...
                        if Assigned(mBookmark) and (mBookMark.Count > 0) then begin
                          ...
                          for i := 0 to mBookMark.Count - 1 do begin
                            ...
                            //if mDBGrid.DataSource.DataSet.FieldByName('ProvideRow_ID').AsString='' then begin
                            ...
                            //end else begin
                            //      NxShowSimpleMessage('Položku nelze změnit, řádek příjemky vznikl z odjednávky',nil);
                            //end;
                      ...
                      if mRbA.Checked then begin
                        ...
                        for i := 0 to mMon.Count - 1 do begin
                          if NxIsEmptyOID(mMon.BusinessObject[i].getFieldValueAsString('ProvideRow_ID')) then begin
