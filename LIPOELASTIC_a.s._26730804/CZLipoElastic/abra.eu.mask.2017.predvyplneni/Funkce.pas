function GetBusTransaction_IDa(mRows:TNxCustomBusinessObject):TNxOID;
begin
...
function GetProject_IDa(mRows:TNxCustomBusinessObject):TNxOID;         // typ obchodu
var
                              ...
                              if mid='' then begin
                                 ...
                                 try
                                  mRows.objectspace.sqlselect('select X_BusProject_ID from defrolldata where clsid=' + quotedstr('0IUJNYXHSF2ORJ2CUL2XVEMLJW') +
                                      ' and X_person_ID=' + quotedstr(mRows.GetFieldValueAsString('Parent_id.Person_ID')) +
                                      ' and X_Bustransaction_ID=' + quotedstr(mRows.GetFieldValueAsString('StoreCard_id.X_BusTransaction_ID'))+ ' and hidden= ' + quotedstr('N'),mr);
                                    if mr.count>0 then begin     // osoba
...
function GetBusOrder_IDa(mRows:TNxCustomBusinessObject):TNxOID;       // obchodník
var
  mr,mr1,mr2:tstringlist;
  mbo:TNxCustomBusinessObject;
  mID:string;
...
function GetBusDivision_IDa(mRows:TNxCustomBusinessObject):TNxOID;
begin
