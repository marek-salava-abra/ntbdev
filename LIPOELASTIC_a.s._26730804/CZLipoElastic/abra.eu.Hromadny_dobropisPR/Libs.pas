...
mFirm_ID='7F26300101';
mDocqueue_ID_DL='0200000101';

DateDiff=1096;


function xxxFindStoreBatchFV(os:TNxCustomObjectSpace;mTMPBO:TNxCustomBusinessObject;mquantity:double;index:integer):double;
 var
 i,x:integer;
 mtext:string;
   mB_Result:boolean;
