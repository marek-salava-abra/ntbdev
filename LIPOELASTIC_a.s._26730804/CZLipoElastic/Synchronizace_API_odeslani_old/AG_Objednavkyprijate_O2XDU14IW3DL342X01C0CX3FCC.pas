                                              ...
                                              for mICount:=0 to mIBookmark do begin
                                                              ...
                                                              mquery:='{'   +chr(10);
                                                                   ...
                                                                   if mTypImportu='OP' then begin
                                                                              ...
                                                                              mfind:=false;
                                                                                   case self.GetFieldValueAsString('DocQueue_ID.CODE') of
                                                                                     ...
                                                                                     if not mFind then  mquery:=mquery + ' "DocQueue_Code":"' +  'OP'  +'", ';
                                                                                     mFind:=true;
                                                                   ...
                                                                   if mTypImportu='OV' then begin
                                                                              ...
                                                                              mfind:=false;
                                                                                   case self.GetFieldValueAsString('DocQueue_ID.CODE') of
                                                                                     ...
                                                                                     if not mFind then  mquery:=mquery + ' "DocQueue_Code":"' +  'SOVE'  +'", ';
                                                                                     mFind:=true;
                                                                              mquery:=mquery + ' "Debug":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "WithPrices":"' +  'True'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Sales":"' +  'False'  +'",'+chr(10);
                                                                   ...
                                                                   if mTypImportu='PR' then begin
                                                                              ...
                                                                              mfind:=false;
                                                                                   case self.GetFieldValueAsString('DocQueue_ID.CODE') of
                                                                                     '': begin
                                                                                               mquery:=mquery + ' "DocQueue_Code":"' +  'PRVS'  +'", ';
                                                                                                 mfind:=true;
                                                                                             end;
                                                                                   end;
                                                                                     if not mFind then  mquery:=mquery + ' "DocQueue_Code":"' +  'PRVS'  +'", ';
                                                                                     mFind:=true;
                                                                              mquery:=mquery + ' "Debug":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "WithPrices":"' +  'True'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Sales":"' +  'False'  +'",'+chr(10);
                                                                   ...
                                                                   if mTypImportu='DL' then begin
                                                                              ...
                                                                              mfind:=false;
                                                                                   case self.GetFieldValueAsString('DocQueue_ID.CODE') of
                                                                                     '': begin
                                                                                               mquery:=mquery + ' "DocQueue_Code":"' +  'DLVS'  +'", ';
                                                                                                 mfind:=true;
                                                                                             end;
                                                                                   end;
                                                                                     if not mFind then  mquery:=mquery + ' "DocQueue_Code":"' +  'DLVS'  +'", ';
                                                                                     mFind:=true;
                                                                              mquery:=mquery + ' "Debug":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "WithPrices":"' +  'True'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Sales":"' +  'False'  +'",'+chr(10);
                                                                   ...
                                                                   if mTypImportu='PRV' then begin
                                                                              ...
                                                                              mfind:=false;
                                                                                   case self.GetFieldValueAsString('DocQueue_ID.CODE') of
                                                                                     ...
                                                                                     if not mFind then  mquery:=mquery + ' "DocQueue_Code":"' +  'XPT'  +'", ';
                                                                                     mFind:=true;
                                                                              mquery:=mquery + ' "Debug":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Sales":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Email":"' +  'mskacel@lipoelastic.com'  +'",'+chr(10);
                                                                   ...
                                                                   if mTypImportu='PRP' then begin
                                                                              ...
                                                                              mfind:=false;
                                                                                   case self.GetFieldValueAsString('DocQueue_ID.CODE') of
                                                                                     ...
                                                                                     if not mFind then  mquery:=mquery + ' "DocQueue_Code":"' +  'YPT'  +'", ';
                                                                                     mFind:=true;
                                                                              mquery:=mquery + ' "Debug":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Sales":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Email":"' +  'mskacel@lipoelastic.com'  +'",'+chr(10);
                                                                   ...
                                                                   if mTypImportu='FV' then begin
                                                                              ...
                                                                              mfind:=false;
                                                                                   case self.GetFieldValueAsString('DocQueue_ID.CODE') of
                                                                                     ...
                                                                                     if not mFind then  mquery:=mquery + ' "DocQueue_Code":"' +  'FVT'  +'", ';
                                                                                     mFind:=true;
                                                                              mquery:=mquery + ' "Debug":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Sales":"' +  'False'  +'",'+chr(10);
                                                                              mquery:=mquery + ' "Email":"' +  'mskacel@lipoelastic.com'  +'",'+chr(10);
                                                                              ...
                                                                              mquery:=mquery + ' "Store_Code":"' +  '22'  +'", ';
                                                                              mquery:=mquery + ' "Division_Code":"' +  'O'  +'", '+chr(10);
                                                  ...
                                                  if mICount<>mIBookmark then begin
                                                   ...
                                                   if not mKumulovane then begin      // index=1 then begin
                                                           mquery:=mquery + ']';
                                                           mquery:=mquery + '}';
                                                       //mboolean:=InputQuery('API','Post 1:1 ','http://10.5.5.11:82/CZ_test'+'/script/NxApiLib/lib/APINxImporManager' + Chr(10) + chr(10) +mQuery);
                                                     ...
                                                     //     NxShowSimpleMessage(' Doklad ' + self.DisplayName + ' byl již odeslán , není možné pokračovat', nil);
                                                     //     exit ;
                                                     //end;
                                                ...
                                                // ukončení abradocuments
                                                  if mKumulovane then begin
                                                     ...
                                                     //     exit ;
                                                     //end;
                                                      //mboolean:=InputQuery('API','Post 1 doklad','http://10.5.5.11:82/CZ_test'+'/script/NxApiLib/lib/APINxImporManager' + Chr(10) + chr(10) +mQuery);
