...
const
  ...
  *)
  ...
  //ID dokladu vytvořené v aktuální relaci. Při opakovaných expedicích ze najdete ID odeslané pošty po vytvoření v odeslané poště.
  cFDCreatedPDMIDs = 'FDCreatedPDMIDs';
