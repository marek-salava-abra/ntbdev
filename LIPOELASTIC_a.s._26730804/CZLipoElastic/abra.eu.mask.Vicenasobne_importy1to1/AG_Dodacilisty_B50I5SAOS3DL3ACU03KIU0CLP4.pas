...
begin
  ...
  mid_report:=iSelectReport('42YXBPUMSZDL3FUD00C5OG4NF4') ;
                         ...
                         //mIportmanager(TDynSiteForm(mSite).CurrentObject,mDocQueue_ID);
                          mStringlist:=TStringList.create;
                                       try
                                            ...
                                            mid:=iPrintDocument(TDynSiteForm(mSite).CurrentObject,'05DOXDMCSZDL3FUD00C5OG4NF4',mid_report,NxCreateContext(msite.BaseObjectSpace),mStringlist,mfilename,'');
                                       finally
                                          mStringlist.free;
                                       end;
              end else begin
...
mOP_ID: string;
  ...
  mText:string;
begin
                if index=0 then mManager := NxCreateDocumentImportManager(self.ObjectSpace,'050I5SAOS3DL3ACU03KIU0CLP4','O3BDOKTWEFD13ACM03KIU0CLP4');   // op to fv
