...
var
 ...
 mDate, mBeginDate, mEndDate, mBegHour, mEndHour:Extended;
 mHour, mMinute:string;
begin
...
procedure SplitString(const Input: string; var Part1, Part2: string);
var
  ColonPos: Integer;
begin
  ColonPos := Pos(':', Input); // Nalezení pozice dvojtečky
  if ColonPos > 0 then
  begin
    // Extrahování části před dvojtečkou
    Part1 := Copy(Input, 1, ColonPos - 1);
    // Extrahování části za dvojtečkou
