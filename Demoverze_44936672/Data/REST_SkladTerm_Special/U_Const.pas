...
const
  ...
  SKLAD_HLAVNI      = '1L00000101'; // pouzije se napr. pro predvyplneni skladu, taky pri vytvoreni novych volnych dokladu
  FIRM_OWN          = 'AAA1000000'; // vlastni firma
  STREDISKO_HLAVNI  = '1400000101'; // středisko

  RADA_PRIJEMKA           = '6N20000101'; // rada Prijemka
  RADA_PREVYDEJ           = '6RB0000101'; // rada Prevodka vydej
  RADA_PREPRIJEM          = '7RC0000101'; // rada Prevodka prijem
  ...
  // cesta, do ktere se ulozi vyfocene fotky
  NEW_PHOTOS_PATH = '';

  CLIENT_CURRENT_VERSION = '4.14.2';    // aktualni verze, ctecky si kontroluji, jestli ji maji
  // toto je potreba nahradit URL dostupnou ze ctecek, na ktere bude vystaveno APK,
  // velmi to usnadnuje instalaci novych verzi
  CLIENT_CURRENT_VERSION_URL = 'http://edling.cz/app/SkladTerm-release-4.14.2-20221108.apk';
...
//   typ dokladu - dle konstant vyse v tomto souboru
...
begin
  case docTyp of
    ...
    //DOC_IncomingTransfer:               Result := '1050000101'; //14.09.2023
    DOC_IncomingTransfer:                 Result := '10B0000101';
