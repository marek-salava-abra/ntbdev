...
function GetActionPrice_ID(AOS : TNxCustomObjectSpace; AStoreCard_ID, aPriceList_ID : string) : string;
const
  cSQL = 'SELECT ID FROM ActionStorePrices WHERE StoreCard_ID=''%s'' and Pricelist_ID=''%s'' ';
var
  mList : TStringList;
begin
  mList := TStringList.Create;
