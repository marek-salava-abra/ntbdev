...
function processSpecialGetRequests(AContext: TNxContext; AHeaders, APath, AQueryParams: TStringList; ABody: String; AResponse: TStringList): Boolean;
begin
  Result := True;
...
function processSpecialPutRequests(AContext: TNxContext; AHeaders, APath, AQueryParams: TStringList; ABody: String; AResponse: TStringList): Boolean;
begin
  Result := True;
  case APath.Strings[0] of
...
function processSpecialPostRequests(AContext: TNxContext; AHeaders, APath, AQueryParams: TStringList; ABody: String; AResponse: TStringList): Boolean;
begin
  Result := True;
  {case APath.Strings[0] of
    else} Result := False;
