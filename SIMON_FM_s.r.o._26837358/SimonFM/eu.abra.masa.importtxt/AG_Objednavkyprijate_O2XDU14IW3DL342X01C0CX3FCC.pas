...
uses 'eu.abra.masa.importtxt.imports';
...
begin
  ...
  case Index of
    0 : mStore_ID := '1B00000101';
    1 : mStore_ID := '1B00000101';
    else
      mStore_ID := '1B00000101';
  end;
  ...
  try
    if mOpenDlg.Execute then begin
      ...
      try
        ...
        Import_AddRows(mBO.GetCollectionMonikerForFieldCode(mBO.GetFieldCode('Rows')), mList, '1100000101', mStore_ID{'1400000101'});
