...
uses 'eu.abra.masa.importtxt.imports2','eu.abra.masa.importtxt.imports';
...
begin
  ...
  mAction.Items.Add('Ze skladu 90 ID');
  ...
  try
    if mOpenDlg.Execute then begin
      ...
      try
        ...
        if index=0 then Import_AddRows2(mBO.GetCollectionMonikerForFieldCode(mBO.GetFieldCode('Rows')), mList, '1100000101', mStore_ID{'1400000101'});
        if index=1 then Import_AddRows(mBO.GetCollectionMonikerForFieldCode(mBO.GetFieldCode('Rows')), mList, '1100000101', mStore_ID{'1400000101'});
