...
begin
  ...
  AReportHelper.ObjectSpace.SQLSelect('Select id from defrolldata where clsid='+Quotedstr('2TIIQXNXIXK4B5CZUIZ20K2W10')+' and X_rel_def='+quotedstr('01')+' and X_Value_ID='+QuotedStr(mID),mList);
