...
begin
  ...
  mMAction.Hint := 'Řazení přebytku dle kódu';
  mMAction.Caption := 'Řazeni přebytku';
  mMAction.Items.Add('Řazení přebytku dle kódu');
  mMAction.Items.Add('Řazení přebytku dle Názvu');
