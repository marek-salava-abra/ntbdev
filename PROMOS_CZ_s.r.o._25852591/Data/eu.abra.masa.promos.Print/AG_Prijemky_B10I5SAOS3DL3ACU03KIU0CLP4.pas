...
begin
 ...
 if Assigned(mBO) then begin
   if NxMessageBox('Dotaz','Přejete si vytisknout štítky z příjemky '+mbo.DisplayName+'?' , mdConfirm, mdbYesNo, 0, 0, False, msite)= mrYes then begin
     ...
     for i:=0 to mRows.count-1 do begin
       ...
       //if mRows.BusinessObject[i].GetFieldValueAsInteger('RowType')=3 then begin
         ...
         //for x:=1 to j do begin
          CFxReportManager.PrintByIDs(NxCreateContext(mOS),mPrintList,GetDynSource(mOS,'BL11000101'),'BL11000101',rtoPrint,pekPDF,'Datamax_E-4205e', '', j);
         //end;
         mPrintList.free;
       end;
     end;
