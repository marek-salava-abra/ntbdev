...
procedure REST_json_addValue(var result: TJSONSuperObject; key: string; AField: TField; empty: boolean = false);
var
  posX: integer;
...
begin
  ...
  for i:= 0 to dt.FieldCount-1 do begin
    ...
    if(auxI > 0)then begin
      ...
      REST_json_addValue(jsonObj, objField, field, true);
      continue;
    end;
    ...
    then begin
      ...
      REST_json_addValue(json, field.FieldName, field, true);
    end;
  end;
