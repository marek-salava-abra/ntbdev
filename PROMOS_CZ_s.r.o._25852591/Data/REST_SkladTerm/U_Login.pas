...
////////////////////////////////////////////////////////////////////////////////
procedure put_LoginToSystem(AContext: TNxContext; ADeviceId, ABody: String; AWithApi: Boolean; AResponse: TStringList);
var
...
begin
  if AWithApi then
    mSecurityUser_ID := NxGetActualUserID(AContext.GetObjectSpace)
  else
  begin
  ...
  begin
    ...
    mSecurityUser.Load(mSecurityUser_ID);
  end
  else
  begin
    mSecurityUser := nil;
  ...
  try
    ...
    begin
      ...
      json.B['canEnterQuantityByBarcode'] := CanEnterQuantityByBarcode;
