...
begin
     ...
     if NxMessageBox('Dotaz','Přejete si změnit obchodní případ na '+inttostr(mlist.count)+' pokladních příjmech?' , mdConfirm, mdbYesNo, 0, 0, False, msite)= mrYes then begin
