   ...
   begin
      ...
      begin
         ...
         begin
            ...
            try
               //Vstupních dokladech (PR, INM atd.) neřešit množství, ale jen pokud je jedna šaže tak tu vyplnit i s množstvím
               mSQL:= 'Select SB.ID '+
               ...
               begin
                  //pokud jich je více (jedno jestli skladem nebo ne) => natvrdo požadovat vybrat (HARD)
                  // => Tohle hlídá validace hlavičky dokladu
               end;
            finally
               mSQLResult.Free;
            end;
