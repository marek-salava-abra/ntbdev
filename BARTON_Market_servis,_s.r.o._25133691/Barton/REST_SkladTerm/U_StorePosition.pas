...
procedure get_StorePositionInfo(AOS: TNxCustomObjectSpace; APath, AResponse: TStringList);
var
...
begin
  ...
  try
    ...
    mSql := getStorePositionInfoSql(AOS, mStorePosition_ID);
    ...
    else if dtHeader.Active and StorePosition_CheckAvailableQuantityImmediately(AOS, gSkladTermModule, gSkladTermDocType, gSkladTermUser_ID, mStoreCard_ID, mStorePosition_ID) then
    begin
