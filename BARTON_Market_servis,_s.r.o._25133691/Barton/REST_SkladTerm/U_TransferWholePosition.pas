  ...
  try
    ...
    try
      ...
      try
        ...
        mDocQueue_ID := GetDocQueue_ID(AOS, gSkladTermModule, DOC_LogStoreTransfer, gSkladTermUser_ID);
  ...
  try
    ...
    try
      ...
      try
        ...
        begin
          mDocQueue_ID := GetDocQueue_ID(AOS, gSkladTermModule, gSkladTermDocType, gSkladTermUser_ID);
        ...
        if dtLSPContents.RecordCount > 0 then
          ...
          begin
            mDocQueue_ID := GetDocQueue_ID(AOS, gSkladTermModule, DOC_LogStoreOutput, gSkladTermUser_ID, gSkladTermDocType, mBoD);
