...
procedure put(AContext: TNxContext; AHeaders, APath, AArguments: TStringList; ABody: TBytes; AResponse: TStringList);
var
...
begin
  ...
  if not processSpecialPutRequests(AContext, AHeaders, APath, mBody, AResponse) then
  begin
    case APath.Strings[0] of
      'login'    : put_LoginToSystem(AContext, AHeaders.Values('DeviceID'), mBody, AResponse);
      ...
      'listDialogSelection': listDialogSelection(mOS, APath, mBody, AResponse);
      ...
      'put_ProcessBarcode': put_ProcessBarcode(mOS, APath, mBody, AResponse);
