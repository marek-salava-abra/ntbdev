...
begin
  ...
  if not Assigned(mSiteForm) then
    Exit;
  if Trunc(Now) > EncodeDate(2023, 12, 1) then
  begin
    ShowMessage('Funkce není od 1.12.2023 podporována !', mSiteForm.GetSiteAppForm);
    Exit;
  end;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        try
          mBO := mSiteForm.BaseObjectSpace.CreateObject(Class_IssuedInvoice);
          try
