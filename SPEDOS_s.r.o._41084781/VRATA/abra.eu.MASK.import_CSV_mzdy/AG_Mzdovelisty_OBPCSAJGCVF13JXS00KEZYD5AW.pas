            ...
            if mImportFile.Count >1 then begin
                 ...
                 while i < mImportFile.Count do begin
                    ...
                    try
                                mfieldValue:= TStringList.Create;
                                //mTargetFile.strings[i]:=mImportFile.strings[i];
                                Parsevalue(mImportFile.strings[i],';',mImportFile.strings[i],mfieldValue,14);
                      mkorekce:=0;
                                                                ...
                                                                // odpracovaný čas
                                                                 ...
                                                                 if mfieldValue.Strings[7] <> '00:00:00' then begin
                                                                  ...
                                                                  if mfieldValue.Strings[11] <> '00:00:00' then begin
                                                                    ...
                                                                    {
                                                                  // fond pracovní doby
                                                                  if mfieldValue.Strings[12] <> '0:00:00' then begin
                                                                      mFcas:=0;
                                                                          mScas:= mfieldValue.Strings[12] ;
                                                                        mFcas:=NxIBStrToFloat(copy(mScas, 1, pos(':', mScas) - 1)) + (NxIBStrToFloat(copy(mScas, (pos(':', mScas) + 1),2 )) / 60);
                                                                         mBO_mzdove_listy.setfieldvalueasfloat('S_WEndHours',mFcas);
                                                                  end;
                                                                   }
                                                                  // odpracovaný svátek
                                                                   if mBO_mzdove_listy.GetFieldValueAsInteger('WorkingRelation_ID.TypeOfWage')=1 then begin
                                                                      if mfieldValue.Strings[13] <> '0:00:00' then begin
                                                                      mFcas:=0;
                                                                          mScas:= mfieldValue.Strings[13] ;
                                                                        mFcas:=NxIBStrToFloat(copy(mScas, 1, pos(':', mScas) - 1)) + (NxIBStrToFloat(copy(mScas, (pos(':', mScas) + 1),2 )) / 60);

                                                                         mkorekce:=mkorekce- mFcas;
                                                                         //mBO_mzdove_listy.setfieldvalueasfloat('S_FeastHours',mFcas);
                                                                      end;
                                                                 end;
                                                                  ...
                                                                  if mfieldValue.Strings[4] <> '00:00' then begin
                                                                     ...
                                                                     if mBO_mzdove_listy.GetFieldValueAsInteger('WorkingRelation_ID.Category')=1 then begin
                                                                          mBO_mzdove_listy.setfieldvalueasfloat('S_MixedHours',mFcas-mkorekce) ;

                                                                           mBO_mzdove_listy.setfieldvalueasfloat('S_MealTicketDemand',trunc((mBO_mzdove_listy.getfieldvalueasfloat('S_MixedHours')/mprac_doba)) );
                                                                          ...
                                                                          mBO_mzdove_listy.setfieldvalueasfloat('S_WorkHours',mFcas-mBO_mzdove_listy.Getfieldvalueasfloat('S_PaidFree'){-mkorekce})
                                                                     end;
                                                                  end;
