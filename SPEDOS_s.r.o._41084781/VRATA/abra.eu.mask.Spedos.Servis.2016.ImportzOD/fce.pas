...
function GetSegment_ID(AOS : TNxCustomObjectSpace; aCode : string) : string;
const
  cSQL = 'SELECT ID FROM DefRollData WHERE Code=''%s'' and clsid=''GFXSWZ2RJNDODCPHQYEGXLRKX4'' and hidden=''N''  ';
var
  mList : TStringList;
begin
