          ...
          try
                  if mBookmark.count=0 then begin                 // pro aktuální záznam
                     ...
                     try
                         ...
                         msite.BaseObjectSpace.SQLSelect('select id from VATReceivedDInvoices2 where parent_id=' + quotedstr(mbo.OID) + ' AND Division_ID=' + quotedstr('O000000101'),mr);
                                  ...
                                  try
                                    ...
                                    if mr2.count>0 then begin
                                       ...
                                       NxShowSimpleMessage('Na dokladu je i jiné středisko než "300", doklad nebude změněn.',nil);
                                        ...
                                        mi:=msite.BaseObjectSpace.SQLExecute('update VATReceivedDInvoices2 set division_ID=' +quotedstr('3W00000101') + ' where parent_id=' + quotedstr(mbo.OID) + ' AND Division_ID=' + quotedstr('O000000101'));
