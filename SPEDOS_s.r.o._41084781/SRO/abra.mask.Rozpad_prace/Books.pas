const
  ...
  cInDebug = True;
  cUseDebugger = True;
  cAppName = 'abra.mask.Rozpad_prace'; // schvalne si to nechavam tady - knihovnu budu davat primo do kazdeho skriptu ne zvlast
  cVATCountry_ID='00000CZ000';
  //cCrLf = Chr(13) + Chr(10);
  cCrLf = #13#10;
...
begin
  ...
  try
   ...
   with edEdit do begin
    ...
    if mForm.ShowModal(ASourceForm) = mrOK then
      Result := edEdit.Text
    else
      Result := '';
  except
